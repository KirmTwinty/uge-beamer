...
\documentclass[notheorems, noamsthm, aspectratio=43, 10pt]{beamer}
	...
	% supported aspect ratios  1610  169 149 54 43 (deault) 32
	%
...
%-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	...
	\usetheme{UGE}
		...
		\metroset{
			...
			progressbar= head, %none, head, frametitle, foot
...
%-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	...
	\titlegraphic{\hspace*{0.38\textwidth}\vspace{0.0mm}%
		\includegraphics[height=0.07\paperheight]{\PathS/inr_logo_rouge.pdf}}
